...
const mockAiData = {
  ...
  overview: {
    ...
    firstSteps: [
      "รักษาเวลาเข้านอนให้ใกล้เคียง 22:00 เน้น Zone 1-3",
      "ขยับร่างกายหรือเดินเบาๆ โซน 1-2 เพื่อเพิ่ม Sleep Consistency",
      "ผ่อนคลายกล้ามเนื้อก่อนนอน เพื่อรักษาความสมดุลชีวิตช่วยให้สุขภาพการนอนดีขึ้นไปอีก",
    ],
  },
  activity: {
    bodyLoadToday: 6.9,
